...
LOCAL_OVERRIDES_PACKAGES := AmbientSensePrebuilt AppDirectedSMSService Chrome Chrome-Stub
LOCAL_OVERRIDES_PACKAGES += Camera2 CarrierSetup ConnMO DCMO LiveWallpapersPicker FMRadio
LOCAL_OVERRIDES_PACKAGES += DMService DevicePolicyPrebuilt Drive PrebuiltGmail
LOCAL_OVERRIDES_PACKAGES += DiagnosticsToolPrebuilt Maps Velvet talkback
...
LOCAL_OVERRIDES_PACKAGES += PixelLiveWallpaperPrebuilt Stk FilesPrebuilt
